...
import { blockedNode } from './nodes/blocked.js';
...
const workflow = new StateGraph(AgentState, ConfigurationSchema)
  ...
  .addConditionalEdges('classifyIntentionNode', routeByIntentNode, {
    consult: 'consultNode',
    conversation: 'conversationNode',
    scheduled: 'scheduledNode',
    cancel: 'cancelNode',
    unknown: 'unknownIntentNode',
    blocked: 'blockedNode',
  })
